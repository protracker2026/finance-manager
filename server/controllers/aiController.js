...
3. "category": หมวดหมู่สั้นๆ ให้พยายามจับคู่กับหมวดหมู่ต่อไปนี้: "อาหาร", "ค่าเดินทาง", "ค่าที่พัก", "ค่าน้ำ-ไฟ", "ค่ามือถือ/เน็ต", "ค่ารักษาพยาบาล", "ช้อปปิ้ง", "ความบันเทิง", "การศึกษา", "ชำระหนี้", "เงินเดือน", "โบนัส", "งานฟรีแลนซ์", "ดอกเบี้ยรับ" (ถ้าไม่แน่ใจให้ใช้ "อื่นๆ")
4. "note": ชื่อรายการ
...
Output JSON:
{"type": "expense", "amount": 65, "category": "อาหาร", "note": "ชาไข่มุก", "quantity": null, "unitPrice": null}
