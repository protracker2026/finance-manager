...
export const InterestEngine = {
    ...
    BOT_RATES: {
        credit_card: {
            ...
            minPaymentFloor: 300,  // ปรับตามความต้องการผู้ใช้: ขั้นต่ำสุด 300 บาท
            method: 'daily_accrual',
            label: 'บัตรเครดิต',
            description: 'ลดต้นลดดอก (เดินรายวัน) คิดจากยอดคงค้าง × (อัตรา / 365)'
        },
        cash_card: {
            maxRate: 25,           // เพดานดอกเบี้ยสูงสุด 25% ต่อปี
            minPaymentPct: 3,      // ชำระขั้นต่ำส่วนใหญ่ 3%
            minPaymentFloor: 300,  // ปรับตามความต้องการผู้ใช้: ขั้นต่ำสุด 300 บาท
            method: 'daily_accrual',
            label: 'บัตรกดเงินสด',
            description: 'ลดต้นลดดอก (เดินรายวัน) คิดจากยอดคงค้าง × (อัตรา / 365)'
